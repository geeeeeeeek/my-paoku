...
public class QieziEnemy  extends BaseEnemy {
    public final static String TAG="QieziEnemy";

    public final static int StartY=150;


    public QieziEnemy(MyPaokuGame mainGame) {
        super(mainGame);
    ...
    public Animation getWalkAnimation() {
        TextureAtlas.AtlasRegion walkRegion=mainGame.getAtlas().findRegion(Res.Atlas.IMAGE_ENEMY_QIEZI_WALK);
    ...
    public Animation getFireAnimation() {
        TextureAtlas.AtlasRegion region=mainGame.getAtlas().findRegion(Res.Atlas.IMAGE_ENEMY_QIEZI_WALK);
    ...
    public Animation getHurtAnimation() {
        TextureAtlas.AtlasRegion region=mainGame.getAtlas().findRegion(Res.Atlas.IMAGE_ENEMY_QIEZI_DEAD);
        Animation animation = new  Animation(0.2F, TextureUtil.getTextureRegions(region,1,4));
        return animation;
    }
